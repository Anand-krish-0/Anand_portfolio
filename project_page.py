...
from Clustering_page import clusterpage
...
def projects():
    ...
    with tab1:
        ...
        if opts == "About dataset":
            ...
            # Displaying all dataset features in one st.write
            st.write("""
            ### Dataset Features:
    ...
    with tab2:
        ...
        with st.container():
            ...
            st.write("""The objective of this project is to build a support vector machine model that can predict diabetes based on the given features. 
                        This model can be useful for finding patients who have diabetes or not. 
                        The features include pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetiesPedigreeFunction, and Age.
                        """)
        ...
        with st.container():
            ...
            st.write("""This project aims to predict whether a loan applicant will be approved for a loan based on 
                        ...
                        CoapplicantIncome, LoanAmount, Loan_Amount_Term, Credit history, and Property Area. 
